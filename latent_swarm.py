...
if __name__ == "__main__":
    ...
    utility_values = torch.load('wdata/utilities_mdt_norm_gsm8k.pt')
    ...
    torch.save(weights, f"./particles/gsm8k_swarm_weights_final.pt")
    # print("Best-found weights (global best):", global_best)
    torch.save(global_best, f"./particles/gsm8k_swarm_global_best_top_1.pt")
