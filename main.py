...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        default="stage1/configs/base_llama_config_kl.yaml",
...
if __name__ == "__main__":
    ...
    checkpoint_callback = ModelCheckpoint(monitor='train/aeloss',
                                          ...
                                          filename='checkpoint_vae_model_full_{epoch}_',
                                          every_n_epochs=10
                                          )
    trainer = pl.Trainer(accelerator="gpu", devices=-1, min_epochs=1000, precision='bf16-mixed',
