...
# from models.myautoencoder import CAutoencoderKL
...
class DDPM(nn.Module):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        return loss #, loss_dict_no_ema, loss_dict_ema
...
class LatentDiffusion(DDPM):
    ...
    # @rank_zero_only
    # @torch.no_grad()
    # def on_train_batch_start(self, batch, batch_idx, epochs):
    #     # only for very first batch
    #     if batch_idx == 0 and epochs==0:
    ...
    def p_sample_loop(self, cond, shape, return_intermediates=False,
        ...
        for i in iterator:
            ...
            if mask is not None:
                ...
                x0 = x0.reshape(-1, self.channels, self.input_size, self.input_size)
                img_orig = self.q_sample(x0, ts)
                img = img_orig * mask + (1. - mask) * img
