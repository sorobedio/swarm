...
class DiffusionWrapper(nn.Module):
    def __init__(self, diff_model_config, conditioning_key):
        ...
        # self.input_adapt = nn.Sequential(nn.Linear(in_dim*in_dim, inchannels*inz*inz))
        # self.output_adapt = nn.Sequential(nn.Linear(inz*inz*inchannels, in_dim*in_dim))
