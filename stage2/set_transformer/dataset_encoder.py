...
class EmbedData(nn.Module):
    def __init__(self,  enconfig, deconfig, emb_dim=1024,in_ch=1, input_size=32, z_dim=512, ckpt_path=None,  **kwargs):
        ...
        self.proj = nn.Linear(z_dim, emb_dim)
    ...
    def forward(self, inputs):
        ...
        for x in inputs:
            ...
            outputs.append(out)
        outputs = torch.stack(outputs, 0).reshape(-1, self.z_dim)
