...
class ZooDataset(Dataset):
    ...
    def __init__(self, root='zoodata', dataset="joint", split='train', topk=None, scale=1.0, transform=None, normalize=False,
        ...
        datapath = os.path.join(root, f'llama3_weights/llama_3_8_1_attn_dict_instruct_last_.pt')
        # datapath = os.path.join(root, f'llama3_weights/llama_3_8_1_attn_dict_instruct_last_.pt')
        # datapath = os.path.join(root, f'llama3_weights/llama_3_8_1_attn_dict_instruct_layer_30_.pt')
