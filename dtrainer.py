...
def train(model, optimizer, n_epochs, traindataloader, testdataloader=None):
    ...
    for epoch in range(n_epochs):
        ...
        if bloss > tloss:
            ...
            torch.save(model, os.path.join(args.save_path,f'llama_full_chunk_topk_100_v.pth'))
...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(log_dir="first_100_full_llama/tensorboard_encod")
    ...
    trainset = ZooDataset(root=args.data,  dataset="joint", split=args.split,
                          scale=10, normalize=None, topk=100)
