...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        default="stage1/configs/small_llama_ln_config_k.yaml",
        #mini_llama_norm_config.yaml
        # default="stage1/configs/mobile_llm_125_base_config_kl.yaml",
        # default="stage1/configs/base_ffn_llama_config_kl.yaml",#was used

        # default="stage1/configs/pythia_70_config_kl.yaml",
        #   default="stage1/configs/pythia_160M_config_kl.yaml",
        #
        # default="stage1/configs/gpt2_base_config_kl.yaml",

        # default="stage1/configs/llama_block_config_kl.yaml",
        # default="stage1/configs/base_lm_head_config_kl.yaml",
        # default="stage1/configs/gpt2_base_mlp_config_kl.yaml",
        #
        #
    )
    parser.add_argument(
...
def train(model, optimizer, n_epochs, traindataloader, testdataloader=None):
    ...
    for epoch in range(n_epochs):
        ...
        if bloss > tloss:
            ...
            torch.save(model, os.path.join(args.save_path,f'llama_3_2_1_3b_inst_norm_.pth'))
...
#0.5
    traindataloader = DataLoader(trainset, shuffle=True, batch_size=2, num_workers=4,
